...
This project uses the **Online Retail II** dataset, which contains transactional records from an international online retail company between **December 2009 and December 2011**.

The dataset includes customer purchases, product information, order quantities, prices, transaction dates, and countries, making it suitable for customer behavior and sales performance analysis.

### Source

- **Kaggle:** https://www.kaggle.com/datasets/mashlyn/online-retail-ii-uci
- **Original Source:** UCI Machine Learning Repository – Online Retail II Dataset
